...
package com.example.corn.tflite;


import static com.example.corn.env.Utils.expit;
...
import com.example.corn.home;
import com.example.corn.env.Logger;
import com.example.corn.env.Utils;
...
//        if (tfLite != null) tfLite.setUseNNAPI(isChecked);
    ...
    public float getObjThresh() {
        return home.MINIMUM_CONFIDENCE_TF_OD_API;
    }
